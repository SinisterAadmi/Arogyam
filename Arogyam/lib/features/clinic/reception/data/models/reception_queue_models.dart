class ReceptionQueueToken {
  ...
  final String? appointmentStatus; // scheduled, confirmed, cancelled, reschedule_requested, pending
  ...
  factory ReceptionQueueToken.fromJson(Map<String, dynamic> json) {
    return ReceptionQueueToken(
      ...
      joinedAt: json['joinedAt'] != null ? DateTime.parse(json['joinedAt']).toLocal() : DateTime.now(),
      updatedAt: json['updatedAt'] != null ? DateTime.parse(json['updatedAt']).toLocal() : DateTime.now(),
    );
  }
}

class ReceptionUpcomingAppointment {
  final String id;
  final String patientId;
  final String patientName;
  ...
  factory ReceptionUpcomingAppointment.fromJson(Map<String, dynamic> json) {
    return ReceptionUpcomingAppointment(
      id: json['id']?.toString() ?? '',
...
class ConsentVerificationResult {
  ...
  factory ConsentVerificationResult.fromJson(Map<String, dynamic> json) {
    ...
    return ConsentVerificationResult(
      ...
      usedAt: json['usedAt'] != null ? DateTime.parse(json['usedAt']).toLocal() : DateTime.now(),
    );
  }
}
...
class AiCallbackItem {
  ...
  factory AiCallbackItem.fromJson(Map<String, dynamic> json) {
    return AiCallbackItem(
      ...
      requestedSlot: json['requestedSlot'] != null ? DateTime.parse(json['requestedSlot']).toLocal() : DateTime.now(),
