...
class MockAppointmentRepository extends AppointmentRepository {
  ...
  @override Future<AppointmentModel> getAppointmentById(String id) async => AppointmentModel(
    id: id,
    doctorName: 'Dr. Test',
    specialty: 'General',
    clinicName: 'Test Clinic',
    appointmentTime: DateTime.now().toIso8601String(),
    tokenNumber: '1',
    status: 'scheduled',
  );
  @override Future<AppointmentModel> cancelAppointment(String id) async => AppointmentModel(
    id: id,
    doctorName: 'Dr. Test',
    specialty: 'General',
    clinicName: 'Test Clinic',
