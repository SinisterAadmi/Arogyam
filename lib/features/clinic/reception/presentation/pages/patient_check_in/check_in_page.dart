          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                const Divider(height: 16),
                _buildSuccessDetailRow('Verified At', '${result.usedAt.hour}:${result.usedAt.minute.toString().padLeft(2, '0')} IST'),
              ],
            ),
          ),
          const SizedBox(height: 20),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Requested: ${cb.requestedSlot.hour}:${cb.requestedSlot.minute.toString().padLeft(2, '0')}',
