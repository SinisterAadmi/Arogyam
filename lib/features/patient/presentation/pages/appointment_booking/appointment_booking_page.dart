...
import '../../widgets/ai_callback_section.dart';
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (_currentStep == BookingStep.confirm) const AICallbackSection(),
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text('Your appointment at ${widget.clinic.name} is scheduled.', textAlign: TextAlign.center, style: GoogleFonts.inter(color: AppColors.textSecondary)),
            const SizedBox(height: 24),
            SizedBox(
              width: double.infinity,
              height: 48,
