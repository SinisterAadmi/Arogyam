...
import 'features/ai_callback/domain/usecases/trigger_vapi_callback.dart';
...
import 'features/patient/domain/usecases/get_appointment_by_id.dart';
import 'features/patient/domain/usecases/cancel_appointment.dart';
import 'features/patient/presentation/providers/appointment_details_provider.dart';
...
void main() async {
  ...
  final triggerVapiCallback = TriggerVapiCallback(aiCallbackRepository);
  final bookAppointment = BookAppointment(appointmentRepository);
  final getAppointmentById = GetAppointmentByIdUseCase(appointmentRepository);
  final cancelAppointment = CancelAppointmentUseCase(appointmentRepository);
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        Provider.value(value: triggerVapiCallback),
        ChangeNotifierProvider(
          create: (_) => AiCallbackProvider(
            ...
            triggerVapiCallbackUseCase: triggerVapiCallback,
          ),
        ),
        ...
        ChangeNotifierProvider(
          create: (_) => AppointmentDetailsProvider(
            appointmentByIdUseCase: getAppointmentById,
            cancelUseCase: cancelAppointment,
          ),
        ),
        ChangeNotifierProvider(
