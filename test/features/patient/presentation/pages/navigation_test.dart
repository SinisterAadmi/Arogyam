...
void main() {
  ...
  Widget createTestWidget() {
    ...
    final prescRepo = MockPrescriptionRepository();
    ...
    final getUpcoming = GetUpcomingAppointmentsUseCase(appointmentRepo);
    final getQueue = GetQueueStatus(queueRepo);
    final getPrescriptions = GetActivePrescriptionsUseCase(prescRepo);
    final bookAppoint = BookAppointment(appointmentRepo);
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => PatientProfileProvider(patientRepository: patientRepo)),
  ...
  testWidgets('Bottom navigation switches tabs and updates UI', (WidgetTester tester) async {
    await tester.runAsync(() async {
      ...
      final homeProvider = tester.element(find.byType(MaterialApp)).read<PatientHomeProvider>();
      homeProvider.setPatient(PatientModel(id: '1', name: 'Test Patient'));
      await settle(tester);
